...
const SAMPLES: Array<[string, Buffer, IPacket<PayloadType | Buffer>]> = [
  ...
  ['ERROR_STATE/true', ...PK(PacketType.ERROR_STATE, [bx('00'), true], 0xe1)],
  ['ERROR_STATE/false', ...PK(PacketType.ERROR_STATE, [bx('01'), false], 0xe2)],

  ['TARE_STATE/true', ...PK(PacketType.TARE_STATE, [bx('00'), true], 0xd4)],
  ['TARE_STATE/false', ...PK(PacketType.TARE_STATE, [bx('01'), false], 0xd5)],

  ['ITEM_STATE/true', ...PK(PacketType.ITEM_STATE, [bx('00'), true], 0xe5)],
  ['ITEM_STATE/false', ...PK(PacketType.ITEM_STATE, [bx('01'), false], 0xe6)],
